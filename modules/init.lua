...
hook.new("connect",function(cl)
	...
	cl:send(encode(cl,004,"Server","LunatrisIRCd0.0-0","DQRSZagiloswz","CFILPQbcefgijklmnopqrstvz","bkloveqjfI"))
	cl:send(encode(cl,005,"CHANTYPES=#","EXCEPTS","INVEX","CHANMODES=eIbq,k,flj,CFPcgimnpstz","CHANLIMIT=#:50","PREFIX=(ov)@+","MAXLIST=bqeI:100","MODES=4","NETWORK=vifinoNet","KNOCK","STATUSMSG=@+","CALLERID=g","are supported by this server"))
